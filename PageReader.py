...
class DigitReader(TemplateReader):
    ...
    studyprefix = cv2.imread('C:/Users/tmccarthy/Documents/pythonprojects/betscans/templates/study_prefix.png', 0)
    info_dict = {}
    ...
    def readNumber(self, page_key, templates_present, number_len, page_img, shift = None):
        ...
        ptprobs = self.findMatch(frame = insert, templates = templates_present, hasKey = True,
                                 prefix='C:/Users/tmccarthy/Documents/pythonprojects/betscans/templates/study')
        ...
        cv2.imwrite('C:/Users/tmccarthy/Documents/pythonprojects/pagereading/cluster_match.png', newfield)
        plt.imshow(newfield)
        plt.show()
...
class BoxReader(TemplateReader):
    ...
    prep_box = cv2.imread('C:/Users/tmccarthy/Documents/pythonprojects/betscans/templates/box.png', 0)
    css_box = cv2.imread('C:/Users/tmccarthy/Documents/pythonprojects/betscans/templates/box2-0.png', 0)
...
##            field = img[val[0], val[1]]
            ...
            ptprobs = self.findMatch(frame = field, templates = ['box2'], hasKey = False,
                                     prefix='C:/Users/tmccarthy/Documents/pythonprojects/betscans/templates/')
            ...
            cv2.imwrite('C:/Users/tmccarthy/Documents/pythonprojects/pagereading/cluster_match.png', show)
